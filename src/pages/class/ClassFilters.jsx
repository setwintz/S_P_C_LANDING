...
function ClassFilters({ noFade, showFilter, setShowFilter, units, selectedStatus, setSelectedStatus, resetFilter, setSelectedUnitId, selectedUnitId }) {
                    ...
                    {/* {isEnterprise && (
                      <div>
                        ...
                        >
                          ...
                          {units.map(unit => (
                            <option key={unit.unit_uuid} value={unit.unit_uuid}>{unit.name}</option>
                          ))}
                        </select>
                      </div>
                    )} */}
