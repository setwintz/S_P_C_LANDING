...
function YearsFilters({ noFade, showFilter, setShowFilter, units, selectedStatus, setSelectedStatus, resetFilter, setSelectedUnitId, selectedUnitId }) {
