...
function StudentProfileFilters({ noFade, showFilter, setShowFilter, units, selectedStatus, setSelectedStatus, resetFilter, setSelectedUnitId, selectedUnitId }) {
...
export default StudentProfileFilters;