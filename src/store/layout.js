...
//   return item ? JSON.parse(item) : themeConfig.layout.navBarColorType;
// };
...
//   navBarStyleType: themeConfig.layout.navBarStyleType,
//   navBarColorType: themeConfig.layout.navBarColorType,
...
//     },
//     // handle navbar style type
//     handleNavBarStyleType: (state, action) => {
//       state.navBarStyleType = action.payload;
//     },
//      // handle navbar color type
//     handleNavBarColorType: (state, action) => {
//       state.navBarColorType = action.payload;
//     },
//     // handle footer type
...
//   handleMenuHidden,
//   handleNavBarType,
//   handleNavBarStyleType,
//   handleNavBarColorType,
//   handleFooterType,
//   handleMobileMenu,
//   handleMonoChrome,
// } = layoutSlice.actions;
...
const initialStates = {
  ...
  navBarType: themeConfig.layout.navBarType,
  navBarStyleType: themeConfig.layout.navBarStyleType,
  navBarColorType: initialNavbarColor(), // Fixed: Use the function to load from localStorage
  footerType: themeConfig.layout.footerType,
  mobileMenu: themeConfig.layout.mobileMenu,
  isMonochrome: initialMonochrome(),
};
...
export const layoutSlice = createSlice({
  ...
  reducers: {
    ...
    handleNavBarColorType: (state, action) => {
      state.navBarColorType = action.payload;
      window.localStorage.setItem("navBarColor", JSON.stringify(action.payload)); // Fixed: Persist to localStorage like other string-based options
    },
    // handle footer type
    handleFooterType: (state, action) => {
      state.footerType = action.payload;
