...
//   return (
//     <div ref={containerRef} className=" overflow-y-auto overflow-x-hidden w-[100%] bg-gray-50 text-slate-600 antialiased selection:bg-indigo-100 selection:text-indigo-900">
//       {/* 1. Navigation */}
//       {/* <nav className={`sticky relative ${showFirstNav ? "" : ""} top-0 w-[100%] z-50 bg-white/80 backdrop-blur-md border-b border-slate-200/60`}> */}
      // <nav className={`sticky relative top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-200/60 ${!isProductsOpen ? 'overflow-hidden' : ''} transition-all duration-300 ease-in-out ${showFirstNav ? 'h-16 opacity-100' : 'h-0 opacity-0'} ${!showFirstNav ? 'pointer-events-none' : ''}`}>
...
//                   animate={{ opacity: 1 }}
//                   exit={{ opacity: 0 }}
//                   className="absolute w-[100%]  bg-black/20 backdrop-blur-sm z-30"
//                   onClick={() => setIsProductsOpen(false)}
//                 /> */}
...
//                 exit={{ opacity: 0, y: -16 }}
//                 transition={{ duration: 0.25, ease: 'easeOut' }}
//                 className=" absolute top-full left-20 w-[100%] bg-gray-100 border-b border-slate-200 shadow-xl z-40"
//               >
